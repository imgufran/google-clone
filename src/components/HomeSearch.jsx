...
export default function HomeSearch() {
  ...
  return (
    <>
      <form
        className="flex w-full mt-5 max-w-[90%] mx-auto border border-gray-200 px-5 py-3 rounded-full hover:shadow-md transition-all duration-200 focus-within:shadow-md sm:max-w-xl lg:max-w-2xl items-center"
        value={input}
